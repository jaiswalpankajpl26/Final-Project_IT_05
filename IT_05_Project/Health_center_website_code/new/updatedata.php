...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>MNNIT Hospital Management System</title>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="#">MNNIT Admin Panel</a>
          <div class="nav-collapse collapse">
            
            <ul class="nav">
              <li><a target="_blank" href="profile.php">Home</a></li>
              <li class="active"><a href="#">Data Grid</a></li>
      ...
      <div class="row-fluid">
        <div class="span2">
			...
			<select name="filter" style="width:177px" onchange="location.href='?filter='+this.value;">
		    	<option value="free" <? echo ($_GET["filter"] == "free")?"selected":"";?>>Filter: some Features</option>
		    	<option value="all" <? echo ($_GET["filter"] == "all")?"selected":"";?>>Filter: All Features</option>
		    </select>
          ...
          <div class="row-fluid">
            <div class="span12">
				...
				<ul class="nav nav-tabs" id="grid-demo-tabs">
					<li class="active"><a href="#demo" data-toggle="tab">DATA FROM TABLE</a></li>
